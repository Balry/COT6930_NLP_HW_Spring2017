...
public class HW1_OpenNLP_MP {
	...
	public static void main(String[] args) throws IOException {
		...
		/*byte[] encoded = Files.readAllBytes(Paths.get("hw1_files/Datasets/news_article.txt"));
		String text = new String(encoded, StandardCharsets.UTF_8);*/
		
		//Read homework dataset file
		Scanner scanner = new Scanner(new File("hw1_files/Datasets/news_article.txt"));
